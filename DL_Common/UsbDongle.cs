...
namespace DL_CommonLibrary
{
    ...
    public static class UsbDongle
    {
        ...
        public static bool WriteMemory(string data)
        {
            ...
            byte[] buf = Misc.ConvertToByteArray(data, _encoding);
            ...
            string ss = Misc.ConvertToString(buffer, 0, 100, _encoding);
        ...
        public static bool ReadMemory(ref string data)
        {
            ...
            data = Misc.ConvertToString(buffer, 0, 100, _encoding);
